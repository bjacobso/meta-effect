...
import { Trigger, Node, Edge, Defaults } from "./dag-types.js";
...
export const exampleDAG = {
  ...
  nodes: [
    { _tag: "task" as const, id: "checkout" as any, uses: "actions/checkout@v4" },
    { _tag: "gate" as const, id: "only_main" as any, condition: "github.ref == 'refs/heads/main'" },
    { _tag: "fanout" as const, id: "fanout_builds" as any },
    { _tag: "task" as const, id: "build_web" as any, run: "pnpm build --filter web" },
    { _tag: "task" as const, id: "build_api" as any, run: "pnpm build --filter api" },
    { _tag: "fanin" as const, id: "join_builds" as any },
  ],
  edges: [
    { from: "checkout" as any, to: "only_main" as any },
    { from: "only_main" as any, to: "fanout_builds" as any, condition: "expr" as const },
